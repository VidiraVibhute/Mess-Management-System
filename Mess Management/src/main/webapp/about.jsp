  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate text-center mb-5">
        ...
        <p class="breadcrumbs"><span class="mr-2"><a href="home.jsp">Home <i class="fa fa-chevron-right"></i></a></span> <span>About <i class="fa fa-chevron-right"></i></span></p>
      </div>
    </div>
  </div>
</section>
 ...
 <div class="container py-5">
  <div class="row py-2">
   <div class="col-md-12 text-center">
    <h2 style="color:red">We Make Delicious &amp; Nutritious Food</h2>
    <p>Welcome to Purnbrahma, where every meal is crafted with care and home-cooked goodness!

At Purnbrahma, we understand the significance of nourishing meals in your busy schedule. We take pride in offering a diverse array of homemade delicacies designed to satisfy both your hunger and your taste buds.

Our mission is simple: to provide a culinary experience that feels like a comforting home-cooked meal away from home. Whether you're a dedicated student with academic pursuits or a hardworking professional navigating daily tasks, our mess is designed to cater to your culinary needs.

What sets Purnbrahma apart is our commitment to quality and authenticity. Our chefs, passionate about their craft, prepare each dish with the finest ingredients, ensuring flavors that resonate with the essence of homemade cooking. From wholesome vegetarian delights to savory non-vegetarian specialties, our menu is curated to offer a delightful variety that appeals to diverse palates.

Moreover, we prioritize your well-being. Hygiene and cleanliness are integral parts of our service. We adhere to stringent standards to ensure a safe dining environment, providing you not just with meals but with a sense of trust and reliability.

Join us at Purnbrahma, where every meal is an ode to comfort, taste, and the essence of home.</p>
