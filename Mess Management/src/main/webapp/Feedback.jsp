		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="home1.jsp"
		...
		<div class=" div-3">
			<div class=" ">
				<div class="col-sm-7 p-4 p-md-5 d-flex align-items-center justify-content-center bg-primary">
					<form action="Feedback" method="POST" class="appointment-form" enctype="multipart/form-data">
						...
						<div class="col-md-12">
								<div class="form-group">
									<input type="textarea" name="feedback" id="feedback" class="form-control" placeholder="Write Feeback here">
								</div>
							</div>
						</div>
